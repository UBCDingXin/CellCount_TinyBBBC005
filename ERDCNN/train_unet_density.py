...
epochs = args.unet1_epochs
resume_epoch = args.unet1_resume_epoch
lr_base = args.unet1_lr_base
lr_decay_epochs = args.unet1_lr_decay_epochs
lr_decay_epochs = [int(epoch) for epoch in lr_decay_epochs.split("_")]
lr_decay_factor = args.unet1_lr_decay_factor
weight_decay = args.unet1_weight_decay
...
def train_unet_density(trainloader, test_images, unet, save_images_folder, path_to_ckpt=None):
