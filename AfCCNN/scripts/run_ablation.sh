...
####################################################################################################################################
# Exp2: Classification CNN + DA
echo "-------------------------------------------------------------------------------------------------"
echo "exp2_rd1: ${BACKBONE_CNN}(Cl)"
...
2>&1 | tee output_exp2_rd1_${BACKBONE_CNN}_Cl_DA_seed_${SEED}.txt

echo "-------------------------------------------------------------------------------------------------"
echo "exp2_rd2: ${BACKBONE_CNN}(Cl)+DA"
CUDA_VISIBLE_DEVICES=1,0 python3 main.py \
...
--lr_base 1e-3 --lr_decay_factor 0.1 --lr_decay_epochs '10_30_50_70' --weight_decay 1e-4 --transform \
--dataAugment --da_flip --da_filter \
2>&1 | tee output_exp2_rd2_${BACKBONE_CNN}_Cl_DA_seed_${SEED}.txt

echo "-------------------------------------------------------------------------------------------------"
echo "exp2_rd3: ${BACKBONE_CNN}(Cl)+DA"
CUDA_VISIBLE_DEVICES=1,0 python3 main.py \
...
--lr_base 1e-3 --lr_decay_factor 0.1 --lr_decay_epochs '10_30_50_70' --weight_decay 1e-4 --transform \
--dataAugment --da_flip --da_filter \
2>&1 | tee output_exp2_rd3_${BACKBONE_CNN}_Cl_DA_seed_${SEED}.txt



####################################################################################################################################
# Exp2: Classification CNN + Ensembling with ResNet34
echo "-------------------------------------------------------------------------------------------------"
echo "exp2_rd1: ${BACKBONE_CNN}(Cl)+EwResNet34"
CUDA_VISIBLE_DEVICES=1,0 python3 main.py \
--experiment_name exp2_rd1 \
--root $ROOT_PATH \
--path_tinybbbc005 $TINY_BBBC005_DATA_PATH \
...
2>&1 | tee output_exp2_rd1_${BACKBONE_CNN}_Cl_EwResNet34_seed_${SEED}.txt

echo "-------------------------------------------------------------------------------------------------"
echo "exp2_rd2: ${BACKBONE_CNN}(Cl)+EwResNet34"
CUDA_VISIBLE_DEVICES=1,0 python3 main.py \
--experiment_name exp2_rd2 \
--root $ROOT_PATH \
--path_tinybbbc005 $TINY_BBBC005_DATA_PATH \
...
2>&1 | tee output_exp2_rd2_${BACKBONE_CNN}_Cl_EwResNet34_seed_${SEED}.txt

echo "-------------------------------------------------------------------------------------------------"
echo "exp2_rd3: ${BACKBONE_CNN}(Cl)+EwResNet34"
CUDA_VISIBLE_DEVICES=1,0 python3 main.py \
--experiment_name exp2_rd3 \
--root $ROOT_PATH \
--path_tinybbbc005 $TINY_BBBC005_DATA_PATH \
...
2>&1 | tee output_exp2_rd3_${BACKBONE_CNN}_Cl_EwResNet34_seed_${SEED}.txt




####################################################################################################################################
# Exp3: Classification CNN + DA
echo "-------------------------------------------------------------------------------------------------"
echo "exp3_rd1: ${BACKBONE_CNN}(Cl)"
CUDA_VISIBLE_DEVICES=1,0 python3 main.py \
...
--lr_base 1e-3 --lr_decay_factor 0.1 --lr_decay_epochs '10_30_50_70' --weight_decay 1e-4 --transform \
--dataAugment --da_flip --da_filter \
2>&1 | tee output_exp3_rd1_${BACKBONE_CNN}_Cl_DA_seed_${SEED}.txt

echo "-------------------------------------------------------------------------------------------------"
echo "exp3_rd2: ${BACKBONE_CNN}(Cl)+DA"
CUDA_VISIBLE_DEVICES=1,0 python3 main.py \
...
--lr_base 1e-3 --lr_decay_factor 0.1 --lr_decay_epochs '10_30_50_70' --weight_decay 1e-4 --transform \
--dataAugment --da_flip --da_filter \
2>&1 | tee output_exp3_rd2_${BACKBONE_CNN}_Cl_DA_seed_${SEED}.txt

echo "-------------------------------------------------------------------------------------------------"
echo "exp3_rd3: ${BACKBONE_CNN}(Cl)+DA"
CUDA_VISIBLE_DEVICES=1,0 python3 main.py \
...
--lr_base 1e-3 --lr_decay_factor 0.1 --lr_decay_epochs '10_30_50_70' --weight_decay 1e-4 --transform \
--dataAugment --da_flip --da_filter \
2>&1 | tee output_exp3_rd3_${BACKBONE_CNN}_Cl_DA_seed_${SEED}.txt



####################################################################################################################################
# Exp3: Classification CNN + Ensembling with ResNet34
echo "-------------------------------------------------------------------------------------------------"
echo "exp3_rd1: ${BACKBONE_CNN}(Cl)+EwResNet34"
CUDA_VISIBLE_DEVICES=1,0 python3 main.py \
--experiment_name exp3_rd1 \
--root $ROOT_PATH \
--path_tinybbbc005 $TINY_BBBC005_DATA_PATH \
...
2>&1 | tee output_exp3_rd1_${BACKBONE_CNN}_Cl_EwResNet34_seed_${SEED}.txt

echo "-------------------------------------------------------------------------------------------------"
echo "exp3_rd2: ${BACKBONE_CNN}(Cl)+EwResNet34"
CUDA_VISIBLE_DEVICES=1,0 python3 main.py \
--experiment_name exp3_rd2 \
--root $ROOT_PATH \
--path_tinybbbc005 $TINY_BBBC005_DATA_PATH \
...
2>&1 | tee output_exp3_rd2_${BACKBONE_CNN}_Cl_EwResNet34_seed_${SEED}.txt

echo "-------------------------------------------------------------------------------------------------"
echo "exp3_rd3: ${BACKBONE_CNN}(Cl)+EwResNet34"
CUDA_VISIBLE_DEVICES=1,0 python3 main.py \
--experiment_name exp3_rd3 \
--root $ROOT_PATH \
--path_tinybbbc005 $TINY_BBBC005_DATA_PATH \
...
2>&1 | tee output_exp3_rd3_${BACKBONE_CNN}_Cl_EwResNet34_seed_${SEED}.txt
