...
def prepare_options():
    ...
    ''' UNET Settings '''
    parser.add_argument('--unet_epochs', type=int, default=200)
    parser.add_argument('--unet_resume_epoch', type=int, default=0)
    parser.add_argument('--unet_batch_size_train', type=int, default=16)
    parser.add_argument('--unet_lr_base', type=float, default=1e-3, help='base learning rate')
    parser.add_argument('--unet_lr_decay_factor', type=float, default=0.01)
    parser.add_argument('--unet_lr_decay_epochs', type=str, default='100_150', help='decay lr at which epoch; separate by _')
    parser.add_argument('--unet_weight_decay', type=float, default=0)
    parser.add_argument('--unet_transform', action='store_true', default=False, help='data augmentation')
    ...
    parser.add_argument('--cnn_lr_decay_factor', type=float, default=0.1)
